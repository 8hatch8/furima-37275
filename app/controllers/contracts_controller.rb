class ContractsController < ApplicationController
  ...
  def contract_params
    params.require(:contract_address).permit(:postal_code, :prefecture_id, :municipality, :address, :building, :tel).merge(item_id: params[:item_id], user_id: current_user.id, token: params[:token])
  end
